...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        ...
        return self.word.lower() in text.split()
...
class AndTrigger(Trigger):
    ...
    def evaluate(self, story):
        if self.firstT.evaluate(story) and self.secondT.evaluate(story):
            return True
        else:
            return False
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, story):
        if self.firstT.evaluate(story) or self.secondT.evaluate(story):
            return True
        else:
            return False
    ...
    for trigger in triggerlist:
        for story in stories:
            if trigger.evaluate(story):
                firedStories.append(story)
    return set(firedStories)
